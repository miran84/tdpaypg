...
public interface Manage2Service {
	...
	void manage2Add(Manage2VO vo, MultipartHttpServletRequest multiRequest) throws IOException, SQLException;
	
	void manage2Mod(Manage2VO vo, MultipartHttpServletRequest multiRequest) throws IOException, SQLException;
