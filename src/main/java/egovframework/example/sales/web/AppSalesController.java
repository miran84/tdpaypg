...
public class AppSalesController {
	...
	@RequestMapping(value = "/app/sales/sales_manage.do", method = {RequestMethod.POST, RequestMethod.GET})
	public String app_sales_manage(HttpSession session, Model model) throws IOException, SQLException {
		
		return "app/sales/sales_manage";
	}
