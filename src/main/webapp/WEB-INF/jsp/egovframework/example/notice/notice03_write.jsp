            ...
            <form name="frm" id="frm" method="post" action="" target="" enctype="multipart/form-data">
                ...
                <table class="table_layout01 board_layout">
                    ...
                    <tbody>
                        ...
                        <tr class="comment">
                            <th>답변</th>
                            <td><textarea class="w_all" name="reply" id="reply" cols="202" rows="7">${noticeVO.reply }</textarea></td>
                        </tr>
                        <tr class="file_add">
                            <th>첨부파일</th>
                            <td>
                ...
                <div class="btn_box">
                    <a href="/notice/notice03.do?view_type=L" class="dark_line_btn">이전</a>
                    <c:if test="${view_type eq 'I'}">
                    ...
                    <a href="/notice/notice03.do" class="gray_line_btn">목록</a>
                </div>
            </form>
        </div>
    </div>
