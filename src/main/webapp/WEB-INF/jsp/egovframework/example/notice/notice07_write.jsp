                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${sessionScope.role_id eq '1001'}">
                                ...
                                <tr>
                                    <th class="order_num">주문번호(영수증번호)</th>
                                    <td>
                                        ${noticeVO.orderno }
                                    </td>													
                                </tr>											
                            ...
                            <c:otherwise>
                                ...
                                <tr>
                                    <th>결제날짜</th>
                                    <td>
                                        <input class="w_all" type="text" id="authdate" name="authdate" value="${noticeVO.authdate }">
                                    </td>													
                                </tr>											
                                <tr>
                                    <th>금액</th>
                                    <td>
                                        <input class="w_all" type="text" id="amount" name="amount" value="${noticeVO.amount }">
                                    </td>													
                                </tr>											
                                <tr>
                                    <td class="order_num">주문번호(영수증번호)</td>
                                    <td>
                                        <input class="w_all" type="text" id="orderno" name="orderno" value="${noticeVO.orderno }">
                                    </td>													
                                </tr>											
                                <tr>
                                    <th>구매자명</th>
                                    <td>
                                        <input class="w_all" type="text" id="username" name="username" value="${noticeVO.username }">
                                    </td>													
                                </tr>											
                                <tr>
                                    <th>상점아이디</th>
                                    <td>
                                        <input class="w_all" type="text" id="userid" name="userid" value="${noticeVO.userid }">
                                    </td>													
                                </tr>											
                                <tr class="editor">
                                    <th>내용</th>
                                        ...
                                        <c:if test="${view_type eq 'I'}">
                                            <div class="file_delete">
                                                ...
                                                <c:forEach var="result" items="${resultList}" varStatus="status">	
                                                    ...
                                                    <label for="delete_check_${result.file_num }">${result.file_nm }
                                                </c:forEach>
                                            </div>
                                        </c:if>	
                                    </td>								
