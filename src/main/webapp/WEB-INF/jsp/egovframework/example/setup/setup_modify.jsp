    ...
    <div class="inner">
        ...
        <div class="layout_wrap">
            <form name="frm" id="frm" method="post" action="" target="">
                ...
                <table class="table_layout01">
                    ...
                    <tbody>
                        <tr>
                            <th>아이디</th>						   
                            <td>
                                <input class="w180" type="text" value="<c:out value="${setupVO.store_id}" />" disabled>
                                <!-- button type="button" class="overlap_check">중복확인</button-->
                            </td>
                            <th>비밀번호</th>
                            <td>
                                <input class="w180" type="password"  value="123456" disabled>
                            </td>
                        </tr>
                        <tr>
                            <th>이름</th>
                            <td>
                                <input class="w180" type="text" name="ceo" id="ceo" value="<c:out value="${setupVO.ceo}" />">
                            </td>
                            <th>휴대폰</th>
                            <td>
                                <input class="w180" type="text" name="phone_num" id="phone_num" value="<c:out value="${setupVO.phone_num}" />">
                            </td>
                        </tr>
                        <tr>
                            <th>현황</th>
                ...
                <div class="btn_box">
                    <a href="/setup/setup_admin.do?view_type=L" class="dark_line_btn">이전</a>
