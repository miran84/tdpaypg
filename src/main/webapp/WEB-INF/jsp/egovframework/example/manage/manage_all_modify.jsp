                ...
                <table class="table_layout01">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th>사업자등록번호</th>
                            <td>
                                <input class="w180" type="text" name="corp_regist_num" placeholder="107-87-86839" id="corp_regist_num" value="${manageVo.corp_regist_num }" disabled>
                            </td>
                        </tr>
                        <tr>
                            <th>대표자생년월일</th>
                            ...
                            <td>
                                <select class="w110" name="corp_type" placeholder="" id="corp_type" >
                                        ...
                                        <option value="A" ${manageVo.corp_type eq 'A' ?'selected':''}>비사업자</option>
                                </select>
                                <input class="w180" type="text" name="corp_regist_num2" placeholder="법인등록번호" id="corp_regist_num2" value="${manageVo.corp_type eq 'A'?'':(manageVo.corp_type eq 'B'? manageVo.corp_regist_num2 : manageVo.corp_regist_num) }" >
                            </td>
                        </tr>
                        <tr>
                            <th>업태</th>
                        ...
                        <tr>
                            <th>Email</th>
                            <td>
                                <input class="w180" type="email" name="email" placeholder="text@test.com" id="email" value="${manageVo.email }" maxlength="50">
                            </td>
                            <th>계약담당자</th>
                            <td>
                        ...
                        <tr>
                            <th>홈페이지</th>
                            <td>
                                <input class="w240" type="text" name="hompage" placeholder="" id="hompage" value="${manageVo.hompage }" maxlength="100">
                            </td>
                            <th>정산담당자</th>
                            <td>
                        ...
                        <tr>							
                            <th>상태구분</th>
                            <td>
                                <select class="w180" name="state" placeholder="" id="state" ${sessionScope.role_id eq '1001'?'':'disabled' }>
    ...
    <script>
        ...
        $(function(){
            ...
            $('#feesType').change(function() {
                var state = $('#feesType option:selected').val();
                $('.fees_text').hide();
                $('.'+state).show();
            });
            ...
            var fileCont = ${fn:length(fileList) };
