            ...
            <form name="frm" id="frm" method="post" action="" target="">
                ...
                <table class="table_layout01">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th>영업대행</th>
                            <td colspan="3">${manageVo.high_business_nm }</td>										
                            <!--  <th>수수료</th>
                            <td>
                                ${manageVo.commission }
                        ...
                        <tr>
                            <th>지급상태</th>
                            <td>${manageVo.tax eq 'Y'?'세금계산서':'원천징수'}
                            </td>									
                            <th>상태구분</th>
                            <td>${manageVo.state eq 'Y'?'사용':'중지'}
                            </td>
                        </tr>
                        <tr>
                            <th>정산방식</th>
                            <td>${manageVo.settlement_type eq 'G'?'일반정산':'직접정산'}
                            </td>									
                            <th>정산주기</th>
