...
<script src="/app/js/settlement_his_view.js"></script>
        ...
        <div class="inner">
            <form name="frm" id="frm" method="post" action="" target="">
                ...
                <fieldset>
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <th>취소일자</th>
                                <td>
                                    <c:out value="${settlementVO.canceldate}" />
                                </td>
                            </tr>
                            <tr>
                                <th>은행</th>
                    ...
                    <div class="send_btn">
                    <button class="btn-active" type="button" onclick="fnHold();">지급보류해제</button>
                    <button class="btn-default" type="button" onclick="location.href='settlement_his.do'">목록</button>
                    </div>
                </fieldset>
            </form>
        </div>
