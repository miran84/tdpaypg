...
<script src="/app/js/history_fail_search.js"></script>
        ...
        <div class="inner">
            <form name="frm" id="frm" action="" method="post">
                <fieldset>
                    ...
                    <div class="send_btn">
                        <button class="btn-active" onclick="history_fail_data();" type="button">내역조회</button>
                        <button class="btn-default" onclick="history_fail_init();" type="reset">초기화</button>
                    </div>
                </fieldset>
            </form>
        </div>
