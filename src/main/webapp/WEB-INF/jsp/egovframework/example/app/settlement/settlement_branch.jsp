    ...
    <div class="inner">
        <nav>
            <select onchange="window.open(value,'_self');" name="" id="">
                ...
                <option value="/app/settlement/settlement_branch.do" selected>대리점별정산조회</option>
...
<section class="manage_basic basic_bg">
    <div class="inner">
        <div class="ttl">
            <h2 class="ttl_left">대리점별정산조회</h2>
            <button onclick="location.href='settlement_branch_search.do'" class="ttl_right" type="button"><span>상세검색</span></button>
        </div>
            ...
            <div class="manage_list_wrap">
                ...
                <div class="manage_list">
                    ...
                    <div class="manage_list_btn">
                        <button onclick="location.href='settlement_branch_detail.do'" type="button">정산정보 상세보기</button>
                    </div>
                </div>
            </div>
        </form>
