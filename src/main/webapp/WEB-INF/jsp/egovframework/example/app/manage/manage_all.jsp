...
<script src="/app/js/manage_all.js"></script>

<section class="manage_basic basic_bg">
    <div class="inner">
        <div class="ttl">
            <h2 class="ttl_left">영업대행관리</h2>
            <button onclick="location.href='manage_all_search.do'" class="ttl_right" type="button"><span>상세검색</span></button>
        </div>
        ...
        <div class="register_btn">
            <button onclick="location.href='manage_all_register.do'" type="button">영업대행등록</button>
        </div>
        </c:if>
