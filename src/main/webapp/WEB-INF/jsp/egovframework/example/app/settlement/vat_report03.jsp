    ...
    <section class="manage_basic basic_bg">
        <div class="inner">
            ...
            <div class="list_tab_wrap">
                <button onclick="location.href='vat_report.do'" type="button">세금계산서</button>
                <button onclick="location.href='vat_report02.do'" type="button">매입세금계산서</button>
                <button onclick="location.href='vat_report03.do'" type="button" class="active">원천징수</button>
            </div>
            ...
            <div class="manage_list_wrap">
                <div class="list_ttl_wrap">
                    <span class="list_ttl">* 신용카드 매출 (원천징수) 사업자 없는 영업대행/대리점</span>
                </div>
