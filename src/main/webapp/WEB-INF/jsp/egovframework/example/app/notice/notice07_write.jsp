...
<script src="/app/js/notice07_write.js"></script>	
                    ...
                    <table>
					    ...
					    <c:choose>
                            ...
                            <tr>
                                <th>결제날짜</th>
                                <td>
                                    <input type="text" id="authdate" name="authdate" value="${noticeVO.authdate }">
                                </td>
                            </tr>	                            
                            <tr>
                                <th>금액</th>
                                <td>
                                    <input type="text" id="amount" name="amount" value="${noticeVO.amount }">
                                </td>
                            </tr>	                            
                            <tr>
                                <th>주문번호(영수증번호)</th>
                                <td>
                                    <input type="text" id="orderno" name="orderno" value="${noticeVO.orderno }">
                                </td>
                            </tr>	                            
                            <tr>
                                <th>구매자명</th>
                                <td>
                                    <input type="text" id="username" name="username" value="${noticeVO.username }">
                                </td>
                            </tr>	                            
                            <tr>
                                <th>상점아이디</th>
                                <td>
                                    <input type="text" id="userid" name="userid" value="${noticeVO.userid }">
                                </td>
                            </tr>	                            
                            <tr>
                                <th>내용</th>
